...
```
docker tag filebeat-custom 383363953763.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```

```
docker push 383363953763.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```